...
export default class extends EventMap {
    ...
    run = async (interaction) => {
        ...
        if (code.startsWith('globalCLI')) {
            ...
            dockerShell(value).then(async ({ stdout, stderr }) => {
                if (stderr) {
            ...
            try {
                ...
                if (consoleOutput) {
                    ...
                    await interaction.editReply({
                        content: `Haha! Pegadinha do malandro! Você achou que veria o token secreto do bot? Nice try! Mas o token está bem guardado em um local secreto e seguro. Continue sonhando em decifrá-lo! ${this.emoji.rs}`,
                        ephemeral: true
                    });
                    return;
                    ...
                    await interaction.editReply({
                        ...
                        this.firebase.ref(`Eval/Command/Prompt/Data/${uniqueId}`).set(code)
                    });
                    return;
                }
